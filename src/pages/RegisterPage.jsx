...
import { registerApi, setStoredAuth } from '../utils/api';
        ...
        <div className="bg-white py-8 px-6 shadow-xl rounded-2xl border border-slate-100 sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-slate-500">Minimum 6 characters required by backend validation.</p>
            </div>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 px-4 text-sm font-bold text-white bg-secondary hover:bg-secondary-hover active:bg-secondary-dark rounded-xl shadow-md hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
